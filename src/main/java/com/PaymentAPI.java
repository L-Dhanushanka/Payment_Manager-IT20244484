...
public class PaymentAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = payObj.insertPayment(request.getParameter("paydate"), 
				 request.getParameter("payamt"), 
				request.getParameter("paytype"), 
				request.getParameter("paycus"), 
				request.getParameter("paycusid")); 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		paras.get("payamt").toString(), 
		paras.get("paytype").toString(), 
		paras.get("paycus").toString(), 
		paras.get("paycusid").toString()); 
		response.getWriter().write(output); 
